...
export default function Proyectos() {
    const { cardBg, cardHover, bgColor, accentColor } = useAccentColors();
    const cards = [
        {
            title: "Web2",
            description:
            ...
            image:
                "https://images.unsplash.com/photo-1581093588401-22d58c2b8c05?auto=format&fit=crop&w=800&q=80",
            link: "/web2",
        },
        {
            title: "Web3",
            ...
            image:
                "https://images.unsplash.com/photo-1639754391034-5e249deedc9a?auto=format&fit=crop&w=800&q=80",
            link: "/web3",
        },
    ];
                ...
                <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10} >
                    {cards.map((card, index) => (
                        <LinkBox
                            ...
                            _hover={{ transform: "translateY(-5px)", bg: cardHover }}
                        >
